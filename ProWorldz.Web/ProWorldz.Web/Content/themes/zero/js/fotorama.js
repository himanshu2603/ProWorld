...
(function (a, b, c, d) {
	...
	$(window).load(function(){
		$('.fotorama__caption.fotorama__caption_overlay').each(function(){
			var $captionWidth = $(this).outerWidth()/2;
			$(this).css({marginLeft : -$captionWidth});
			$(this).stop(true).delay(300).animate({opacity : 1}, 400);
		});
	});
